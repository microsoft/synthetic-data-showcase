import{r as o,cj as w,cf as N,cw as W,I as f,cx as y,j as a,T as _,cy as Q,c6 as H,cz as Y,cA as X,a3 as F,cp as B,cc as b,a2 as q,aB as m,ah as M,cB as E,cC as R,cD as I,cE as P,ac as J,aa as U,Q as Z,R as K,cu as ee,ci as te,cF as ne,cb as se,P as oe}from"./main.3bcc7f9a.js";/*!
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const ce=16,ie=o.exports.memo(function({contextKey:t,headerName:s,columnIndex:n,height:r,width:c,chartBarHeight:l,minHeight:i,selectedAttributes:h,selectedAttributesByColumn:p,onSetSelectedAttributes:d}){const[u,g]=o.exports.useState([]),[C]=N(),x=ae(u),$=o.exports.useRef(!0),v=W(),A=o.exports.useCallback(async S=>{const k=S?.value;k===void 0||h.has(k)?await d(n,void 0):await d(n,S)},[h,d,n]);return o.exports.useEffect(()=>{C&&C.instance.attributesIntersectionsByColumn(t,[s]).then(S=>{!$.current||!S||g(S[n]??[])}).catch(()=>{$.current})},[C,g,s,n,t,p]),o.exports.useEffect(()=>()=>{$.current=!1},[]),f(y,{styles:{root:{height:r,minHeight:i,width:c}},children:[a(y.Item,{children:a(_,{styles:{root:{fontWeight:"bold"}},children:s})}),a(y.Item,{styles:{root:{overflowY:"auto",paddingRight:"20px"}},onWheel:v,children:a(Q,{items:u,onClick:A,maxCount:x,height:l*Math.max(u.length,1)+ce,selectedAttributes:h})})]})});/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const le=o.exports.memo(function({contextKey:t,viewHeight:s,headers:n,selectedHeaders:r,chartHeight:c,chartWidth:l,chartBarHeight:i,chartMinHeight:h,selectedAttributesByColumn:p,onSetSelectedAttributes:d}){const u=H(),g=Y();return f(y,{children:[a(X,{}),a(y,{wrap:!0,tokens:{childrenGap:u.spacing.m},styles:{root:{height:s,overflowY:"hidden",padding:u.spacing.s1}},onWheel:g,verticalAlign:"space-between",children:n.map((C,x)=>r[x]&&a(y.Item,{children:a(ie,{contextKey:t,headerName:C,columnIndex:x,height:c,width:l,chartBarHeight:i,minHeight:h,selectedAttributes:p[x]??new Set,selectedAttributesByColumn:p,onSetSelectedAttributes:d})},x))})]})});/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const L=o.exports.memo(function(){const[t,{toggle:s}]=J(!1),n=U("select-columns-id"),[r]=I(),[c,l]=P(),i=Se(c,l),h=o.exports.useCallback(d=>{const u=r.map(()=>d);l(u)},[r,l]),p=o.exports.useMemo(()=>r.map((d,u)=>a(we,{label:d,checked:c[u]??!1,onChange:()=>i(u)},d)),[r,c,i]);return f(B,{children:[a(xe,{id:n,onClick:s,children:"Select Columns"}),t&&a(Z,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:K.bottomCenter,target:`#${n}`,onDismiss:s,setInitialFocus:!0,children:f(ye,{vertical:!0,children:[f($e,{justify:"space-around",align:"center",children:[a(z,{onClick:()=>h(!0),children:"All"}),a(ke,{children:"|"}),a(z,{onClick:()=>h(!1),children:"None"})]}),a(ve,{vertical:!0,children:a("div",{children:p})})]})})]})});L.displayName="SelectNavigateColumns";const xe=m.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const T=o.exports.memo(function({onFullScreenToggle:t}){const[s,n]=o.exports.useState(!0),[r,c]=o.exports.useState(!1),[l,i]=E(),[h]=N(),p=o.exports.useRef(!0),d=ee(),[u,g]=R(),[C,x]=I(),[,$]=P(),v=D(u?.key,n,p,i,h),A=O(v,l),S=ge(v),k=Ce(u?.key,n,p,x,$,h),j=H();o.exports.useEffect(()=>{S(),k()},[u,S,k]),o.exports.useEffect(()=>()=>{p.current=!1},[]);const V=o.exports.useCallback(()=>{t&&t(!r),c(!r)},[c,r,t]);return f(Ae,{vertical:!0,children:[f(b,{align:"center",style:{padding:j.spacing.m,paddingBottom:0,width:"100%"},children:[a(te,{grow:1,shrink:0,children:a(ne,{selectedSynthesis:u,allSynthesisInfo:d,onChange:g,disabled:d.length===0||s})}),a(Ne,{onClick:V,iconName:r?"ChromeClose":"FullScreen"})]}),f(b,{align:"center",children:[a(L,{}),a(he,{headers:C,selectedAttributesByColumn:l,onSetSelectedAttributes:A,onClearSelectedAttributes:S})]})]})});T.displayName="NavigateCommands";const Ae=m(b)`
	border-bottom: 1px solid ${e=>e.theme.palette.neutralLight};
	box-shadow: ${e=>e.theme.effects.elevation4};
`,Ne=m(M)`
	color: ${e=>e.theme.palette.themePrimary};
...
//# sourceMappingURL=index.a8a41dae.js.map
