import{cf as E,r as s,cg as ne,ch as se,aB as r,cc as b,ci as D,cj as ie,bE as oe,I as f,j as t,ck as re,cl as ae,cm as k,cn as le,co as Q,c4 as ce,cp as S,cq as R,cr as N,b$ as T,b_ as ue,ac as I,aa as A,Q as P,R as L,T as de,a3 as j,ah as me,c6 as he,cs as pe,cb as ge,P as be}from"./main.3bcc7f9a.js";/*!
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const X=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),d=A("select-columns-id"),[i,m]=k(),a=De(m),c=s.exports.useCallback(u=>{const y=i.headers.map(x=>({...x,use:u}));m(x=>({...x,headers:y}))},[i,m]),h=s.exports.useMemo(()=>i.headers.map((u,y)=>t(Ve,{label:u.name,checked:u.use,onChange:()=>a(y)},u.fieldName)),[i,a]);return f(S,{children:[t(je,{id:d,onClick:o,children:"Select Columns"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${d}`,onDismiss:o,setInitialFocus:!0,children:f(Re,{vertical:!0,children:[f(Ne,{justify:"space-around",align:"center",children:[t(Z,{onClick:()=>c(!0),children:"All"}),t(Te,{children:"|"}),t(Z,{onClick:()=>c(!1),children:"None"})]}),t(Fe,{vertical:!0,children:t("div",{children:h})})]})})]})});X.displayName="SelectColumns";const je=r.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
...
//# sourceMappingURL=index.42a656e9.js.map
