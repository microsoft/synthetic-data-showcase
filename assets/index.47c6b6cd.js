import{r as o,ci as w,ce as N,cv as W,I as f,cw as y,o as a,R as _,cx as Y,c4 as H,cy as Q,cz as X,a1 as F,co as B,cb as b,a0 as q,az as m,af as M,cA as E,cB as O,cC as I,cD as P,aa as J,a8 as U,O as Z,P as K,ct as ee,ch as te,cE as ne,c9 as se,ca as oe}from"./main.b1d142bc.js";/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */function ae(e){return o.exports.useMemo(()=>Number(w.max([w.maxBy(e,t=>t.estimatedCount)?.estimatedCount,w.maxBy(e,t=>t.actualCount??0)?.actualCount]))??1,[e])}function re(e){return o.exports.useMemo(()=>Object.entries(e),[e])}/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const ce=16,ie=o.exports.memo(function({contextKey:t,headerName:s,columnIndex:n,height:r,width:c,chartBarHeight:l,minHeight:i,selectedAttributes:h,selectedAttributesByColumn:p,onSetSelectedAttributes:d}){const[u,g]=o.exports.useState([]),[C]=N(),x=ae(u),$=o.exports.useRef(!0),k=W(),A=o.exports.useCallback(async S=>{const v=S?.value;v===void 0||h.has(v)?await d(n,void 0):await d(n,S)},[h,d,n]);return o.exports.useEffect(()=>{C&&C.instance.attributesIntersectionsByColumn(t,[s]).then(S=>{!$.current||!S||g(S[n]??[])}).catch(()=>{$.current})},[C,g,s,n,t,p]),o.exports.useEffect(()=>()=>{$.current=!1},[]),f(y,{styles:{root:{height:r,minHeight:i,width:c}},children:[a(y.Item,{children:a(_,{styles:{root:{fontWeight:"bold"}},children:s})}),a(y.Item,{styles:{root:{overflowY:"auto",paddingRight:"20px"}},onWheel:k,children:a(Y,{items:u,onClick:A,maxCount:x,height:l*Math.max(u.length,1)+ce,selectedAttributes:h})})]})});/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */function R(e,t,s,n,r){return o.exports.useCallback(async c=>{if(r&&e)try{await r.instance.selectAttributes(e,c),s.current&&n(c)}catch{t(!1),n({})}},[r,t,s,n,e])}/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */function D(e,t){return o.exports.useCallback(async(s,n)=>{await e({...t,[s]:n!==void 0?new Set([n.value]):new Set})},[e,t])}/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */function Se(e,t){return o.exports.useCallback(async s=>{const n=[...e];n[s]=!n[s],await t(n)},[t,e])}/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const G=o.exports.memo(function({isFullScreen:t}){const[,s]=o.exports.useState(!0),[n,r]=E(),[c]=N(),l=o.exports.useRef(!0),[i]=O(),[h]=I(),[p]=P(),d=R(i?.key,s,l,r,c),u=D(d,n),g=t?"calc(100vh - 161px)":"calc(100vh - 278px)",C=`calc((${g} / 2) - 25px)`;return a(be,{children:a(le,{contextKey:i?.key??"",viewHeight:g,headers:h,selectedHeaders:p,chartHeight:C,chartWidth:400,chartBarHeight:40,chartMinHeight:150,selectedAttributesByColumn:n,onSetSelectedAttributes:u})})});G.displayName="ChartArea";const be=m.div`
	height: 100%;
	width: 100%;
`;/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const L=o.exports.memo(function(){const[t,{toggle:s}]=J(!1),n=U("select-columns-id"),[r]=I(),[c,l]=P(),i=Se(c,l),h=o.exports.useCallback(d=>{const u=r.map(()=>d);l(u)},[r,l]),p=o.exports.useMemo(()=>r.map((d,u)=>a(we,{label:d,checked:c[u]??!1,onChange:()=>i(u)},d)),[r,c,i]);return f(B,{children:[a(xe,{id:n,onClick:s,children:"Select Columns"}),t&&a(Z,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:K.bottomCenter,target:`#${n}`,onDismiss:s,setInitialFocus:!0,children:f(ye,{vertical:!0,children:[f($e,{justify:"space-around",align:"center",children:[a(z,{onClick:()=>h(!0),children:"All"}),a(ve,{children:"|"}),a(z,{onClick:()=>h(!1),children:"None"})]}),a(ke,{vertical:!0,children:a("div",{children:p})})]})})]})});L.displayName="SelectNavigateColumns";const xe=m.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const T=o.exports.memo(function({onFullScreenToggle:t}){const[s,n]=o.exports.useState(!0),[r,c]=o.exports.useState(!1),[l,i]=E(),[h]=N(),p=o.exports.useRef(!0),d=ee(),[u,g]=O(),[C,x]=I(),[,$]=P(),k=R(u?.key,n,p,i,h),A=D(k,l),S=ge(k),v=Ce(u?.key,n,p,x,$,h),V=H();o.exports.useEffect(()=>{S(),v()},[u,S,v]),o.exports.useEffect(()=>()=>{p.current=!1},[]);const j=o.exports.useCallback(()=>{t&&t(!r),c(!r)},[c,r,t]);return f(Ae,{vertical:!0,children:[f(b,{align:"center",style:{padding:V.spacing.m,paddingBottom:0,width:"100%"},children:[a(te,{grow:1,shrink:0,children:a(ne,{selectedSynthesis:u,allSynthesisInfo:d,onChange:g,disabled:d.length===0||s})}),a(Ne,{onClick:j,iconName:r?"ChromeClose":"FullScreen"})]}),f(b,{align:"center",children:[a(L,{}),a(he,{headers:C,selectedAttributesByColumn:l,onSetSelectedAttributes:A,onClearSelectedAttributes:S})]})]})});T.displayName="NavigateCommands";const Ae=m(b)`
	border-bottom: 1px solid ${e=>e.theme.palette.neutralLight};
	box-shadow: ${e=>e.theme.effects.elevation4};
`,Ne=m(M)`
	color: ${e=>e.theme.palette.themePrimary};
...
//# sourceMappingURL=index.47c6b6cd.js.map
