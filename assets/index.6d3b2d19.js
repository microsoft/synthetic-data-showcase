import{cc as E,r as s,cd as se,ce as oe,az as i,c9 as f,cf as M,cg as re,bC as ie,I as C,o as t,ch as ae,ci as le,cj as S,ck as ce,cl as Q,c2 as ue,cm as k,cn as D,co as W,bZ as N,bY as me,aa as I,a8 as A,O as P,P as L,R as de,a1 as j,af as he,c4 as pe,cp as ge}from"./main.6a443a0c.js";/*!
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const J=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),c=A("multi-value-columns"),[r,d]=s.exports.useState(";"),[l,u]=S(),h=s.exports.useCallback(a=>{d(a.target.value??";")},[d]),m=s.exports.useMemo(()=>l.headers.filter(a=>a.name!==l.subjectId&&a.use&&l.metadata?.columns[a.name].type==="string").map(a=>a.name),[l]),x=s.exports.useCallback(()=>{!m.length||o()},[m,o]),$=s.exports.useMemo(()=>m.length?"":"disabled",[m]),p=s.exports.useCallback((a,v)=>{u(b=>({...b,headers:[...b.headers.slice(0,a),{...b.headers[a],spreadWithDelimiter:v},...b.headers.slice(a+1)]}))},[u]),y=s.exports.useCallback(a=>{const v=l.headers.map(b=>m?.includes(b.name)?{...b,spreadWithDelimiter:a?b.spreadWithDelimiter??r:null}:b);u(b=>({...b,headers:v}))},[l,u,r,m]),g=s.exports.useMemo(()=>l.headers.map((a,v)=>!a.use||!m?.includes(a.name)?null:C(Pe,{className:(v+1)%2!==0?"odd":"",justify:"space-between",align:"center",children:[t(Re,{label:a.name,checked:a.spreadWithDelimiter!==null,onChange:(b,w)=>p(v,w?r:null)}),t(Le,{className:a.spreadWithDelimiter!==null?"enabled":"",children:t(B,{value:a.spreadWithDelimiter??"",onChange:b=>p(v,b.target.value)})})]},a.name)),[l,m,p,r]);return C(k,{children:[t(Se,{className:$,id:c,onClick:x,children:"Multi-value Columns"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${c}`,onDismiss:o,setInitialFocus:!0,children:C(ke,{vertical:!0,children:[C(we,{vertical:!0,children:[C(f,{justify:"space-around",align:"center",children:[t(H,{onClick:()=>y(!0),children:"All"}),t(Ie,{children:"|"}),t(H,{onClick:()=>y(!1),children:"None"})]}),C(ze,{align:"center",justify:"space-between",children:[t(de,{htmlFor:"default-delimiter",children:"Default Delimiter: "}),t(Me,{children:t(B,{type:"text",id:"default-delimiter",onChange:h,value:r})})]})]}),t(Ae,{vertical:!0,children:t("div",{children:g})})]})})]})});J.displayName="MultiValueColumns";const Se=i.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const ee=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),c=A("select-columns-id"),[r,d]=S(),l=s.exports.useMemo(()=>r.headers.filter(p=>p.use),[r]),u=s.exports.useMemo(()=>r.subjectId,[r]),h=s.exports.useMemo(()=>l.length?"":"disabled",[l]),m=s.exports.useCallback(()=>{!l.length||o()},[l,o]),x=s.exports.useCallback(p=>{d(y=>({...y,subjectId:p===y.subjectId?void 0:p}))},[d]),$=s.exports.useMemo(()=>l.map((p,y)=>C(Je,{onClick:()=>x(p.name),className:p.name===u?"activeListItem":"",children:[t(he,{iconName:"CheckMark"}),p.name]},p.name)),[u,l,x]);return C(k,{children:[t(Ue,{className:h,id:c,onClick:m,children:"Subject ID"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${c}`,onDismiss:o,setInitialFocus:!0,children:t(_e,{vertical:!0,children:t(Ye,{vertical:!0,children:t("div",{children:$})})})})]})});ee.displayName="SubjectId";const Ue=i.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
...
//# sourceMappingURL=index.6d3b2d19.js.map
