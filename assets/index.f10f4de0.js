import{cc as E,r as s,cd as se,ce as oe,az as i,c9 as f,cf as M,cg as re,bC as ie,I as C,o as t,ch as ae,ci as le,cj as k,ck as ce,cl as Q,c2 as ue,cm as S,cn as D,co as W,bZ as N,bY as me,aa as I,a8 as A,O as P,P as L,R as de,a1 as j,af as he,c4 as pe,cp as ge}from"./main.c40e537d.js";/*!
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const U=s.exports.memo(function(){const n=s.exports.useRef(""),[o]=E(),[c]=k(),[r,d]=s.exports.useState(null),[l,u]=s.exports.useState(!1),[,h]=ce(),[m]=Q(),x=be(),$=fe(r),p=Ce(r),y=s.exports.useCallback(a=>`Affecting ${r?.numberOfRecordsWithRareCombinationsPerColumn[a.label]}/${r?.numberOfRecordsWithRareCombinations} rare/linkable subjects (${a.raw}%)`,[r]),g=s.exports.useCallback(a=>`Affecting ${r?.numberOfRecordsWithRareCombinationsPerAttribute[a.label]}/${r?.numberOfRecordsWithRareCombinations} rare/linkable subjects (${a.raw}%)`,[r]);return s.exports.useEffect(()=>{u(!0),h(void 0),x(c,m.recordLimit,m.reportingLength,m.resolution).then(async a=>{const v=await a?.id;n.current=v;try{const b=await await a?.promise??null;v===n.current&&d(b)}catch(b){n.current!==""&&(h(b),d(null))}finally{n.current!==""&&u(!1)}})},[x,c,m.recordLimit,m.reportingLength,m.resolution,d,u,h]),s.exports.useEffect(()=>()=>{o?.instance.forceAggregateStatisticsWorkerToTerminate(),n.current=""},[o]),t($e,{vertical:!0,align:"center",children:l?t(ue,{}):r&&r.numberOfRecordsWithRareCombinations>0?C(S,{children:[t(O,{children:t("b",{children:`Privacy risk of selected columns: ${(r.numberOfRecordsWithRareCombinations*100/r.numberOfRecords).toFixed(0)}% of subjects (${r.numberOfRecordsWithRareCombinations}/${r.numberOfRecords}) are linkable to small groups below the privacy resolution`})}),C(xe,{justify:"space-between",children:[t(T,{children:t(z,{valuePerKey:$,label:"Most linkable columns",containerHeight:220,barHeight:10,tooltipFormatter:y})}),t(T,{children:t(z,{valuePerKey:p,label:"Most linkable attributes",containerHeight:220,barHeight:10,tooltipFormatter:g})})]})]}):t(O,{children:"No rare attribute combinations (below the privacy resolution) based on the current parameters"})})});U.displayName="AggregateStatistics";/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const _=s.exports.memo(function(){const[n]=k(),o=s.exports.useMemo(()=>{const c=n.subjectId,r=n.table.numRows(),d=n.headers.reduce((l,u)=>{const h=n.metadata?.columns[u.name];return u.use&&h&&u.name!==c&&(l.count+=1,l.unique+=h.stats?.distinct??0,l.combinations*=h.stats?.distinct??1),l},{count:0,unique:0,combinations:1});return d.count?`${d.count} columns and ${r} records.`:"0 columns selected"},[n]);return t(ve,{justify:"center",children:o})});_.displayName="InfoBar";const ve=i(f)`
	padding: ${e=>e.theme.spacing.m};
	font-size: ${e=>e.theme.fonts.large.fontSize};
`;/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const Y=s.exports.memo(function(){const[n]=Q(),o=D(W("resolution")),c=D(W("reportingLength"));return C(f,{align:"center",children:[t(F,{children:"Privacy Resolution"}),t(V,{labelPosition:N.top,min:1,step:1,value:n.resolution.toString(),onChange:o}),t(F,{children:"Aggregation Limit"}),t(V,{labelPosition:N.top,min:1,step:1,value:n.reportingLength.toString(),onChange:c})]})});Y.displayName="AggregationControls";const V=i(me)`
	width: 60px;
`,F=i.span`
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const J=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),c=A("multi-value-columns"),[r,d]=s.exports.useState(";"),[l,u]=k(),h=s.exports.useCallback(a=>{d(a.target.value??";")},[d]),m=s.exports.useMemo(()=>l.headers.filter(a=>a.name!==l.subjectId&&a.use&&l.metadata?.columns[a.name].type==="string").map(a=>a.name),[l]),x=s.exports.useCallback(()=>{!m.length||o()},[m,o]),$=s.exports.useMemo(()=>m.length?"":"disabled",[m]),p=s.exports.useCallback((a,v)=>{u(b=>({...b,headers:[...b.headers.slice(0,a),{...b.headers[a],spreadWithDelimiter:v},...b.headers.slice(a+1)]}))},[u]),y=s.exports.useCallback(a=>{const v=l.headers.map(b=>m?.includes(b.name)?{...b,spreadWithDelimiter:a?b.spreadWithDelimiter??r:null}:b);u(b=>({...b,headers:v}))},[l,u,r,m]),g=s.exports.useMemo(()=>l.headers.map((a,v)=>!a.use||!m?.includes(a.name)?null:C(Pe,{className:(v+1)%2!==0?"odd":"",justify:"space-between",align:"center",children:[t(Re,{label:a.name,checked:a.spreadWithDelimiter!==null,onChange:(b,w)=>p(v,w?r:null)}),t(Le,{className:a.spreadWithDelimiter!==null?"enabled":"",children:t(B,{value:a.spreadWithDelimiter??"",onChange:b=>p(v,b.target.value)})})]},a.name)),[l,m,p,r]);return C(S,{children:[t(ke,{className:$,id:c,onClick:x,children:"Multi-value Columns"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${c}`,onDismiss:o,setInitialFocus:!0,children:C(Se,{vertical:!0,children:[C(we,{vertical:!0,children:[C(f,{justify:"space-around",align:"center",children:[t(H,{onClick:()=>y(!0),children:"All"}),t(Ie,{children:"|"}),t(H,{onClick:()=>y(!1),children:"None"})]}),C(ze,{align:"center",justify:"space-between",children:[t(de,{htmlFor:"default-delimiter",children:"Default Delimiter: "}),t(Me,{children:t(B,{type:"text",id:"default-delimiter",onChange:h,value:r})})]})]}),t(Ae,{vertical:!0,children:t("div",{children:g})})]})})]})});J.displayName="MultiValueColumns";const ke=i.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const X=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),c=A("select-columns-id"),[r,d]=k(),l=je(d),u=s.exports.useCallback(m=>{const x=r.headers.map($=>({...$,use:m}));d($=>({...$,headers:x}))},[r,d]),h=s.exports.useMemo(()=>r.headers.map((m,x)=>t(Ve,{label:m.name,checked:m.use,onChange:()=>l(x)},m.fieldName)),[r,l]);return C(S,{children:[t(De,{id:c,onClick:o,children:"Select Columns"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${c}`,onDismiss:o,setInitialFocus:!0,children:C(We,{vertical:!0,children:[C(Ne,{justify:"space-around",align:"center",children:[t(Z,{onClick:()=>u(!0),children:"All"}),t(Oe,{children:"|"}),t(Z,{onClick:()=>u(!1),children:"None"})]}),t(Te,{vertical:!0,children:t("div",{children:h})})]})})]})});X.displayName="SelectColumns";const De=i.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const ee=s.exports.memo(function(){const[n,{toggle:o}]=I(!1),c=A("select-columns-id"),[r,d]=k(),l=s.exports.useMemo(()=>r.headers.filter(p=>p.use),[r]),u=s.exports.useMemo(()=>r.subjectId,[r]),h=s.exports.useMemo(()=>l.length?"":"disabled",[l]),m=s.exports.useCallback(()=>{!l.length||o()},[l,o]),x=s.exports.useCallback(p=>{d(y=>({...y,subjectId:p===y.subjectId?void 0:p}))},[d]),$=s.exports.useMemo(()=>l.map((p,y)=>C(Je,{onClick:()=>x(p.name),className:p.name===u?"activeListItem":"",children:[t(he,{iconName:"CheckMark"}),p.name]},p.name)),[u,l,x]);return C(S,{children:[t(Ue,{className:h,id:c,onClick:m,children:"Subject ID"}),n&&t(P,{role:"dialog",gapSpace:0,isBeakVisible:!1,directionalHint:L.bottomCenter,target:`#${c}`,onDismiss:o,setInitialFocus:!0,children:t(_e,{vertical:!0,children:t(Ye,{vertical:!0,children:t("div",{children:$})})})})]})});ee.displayName="SubjectId";const Ue=i.span`
	font-size: ${e=>e.theme.fonts.mediumPlus.fontSize};
	/* font-weight: bold; */
	letter-spacing: 1.25px;
	padding: ${e=>e.theme.spacing.m};
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const te=s.exports.memo(function(){return C(Xe,{justify:"center",align:"center",wrap:!0,children:[t(X,{}),t(R,{children:"|"}),t(ee,{}),t(R,{children:"|"}),t(K,{}),t(R,{children:"|"}),t(J,{}),t(Y,{})]})});te.displayName="SelectCommands";const Xe=i(f)`
	border-bottom: 1px solid ${e=>e.theme.palette.neutralLight};
	box-shadow: ${e=>e.theme.effects.elevation4};
`,R=i.span`
	font-size: ${e=>e.theme.fonts.smallPlus.fontSize};
 ...
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const ne=s.exports.memo(function(){const[n]=k(),o=pe(),c=s.exports.useMemo(()=>n.headers.filter(r=>r.use).map(r=>r.name),[n]);return c.length?t(Ke,{children:t(ge,{table:n.table,metadata:n.metadata,features:{histogramColumnHeaders:!0,statsColumnHeaders:!0},isSortable:!0,isHeadersFixed:!0,showColumnBorders:!0,visibleColumns:c,styles:{root:{height:800,border:`1px solid ${o.palette.neutralLight}`}}})}):t(S,{})});ne.displayName="TablePreview";const Ke=i.div`
	height: 100%;
	min-height: 150px;
`;/*!
 * Copyright (c) Microsoft. All rights reserved.
 * Licensed under the MIT license. See LICENSE file in the project.
 */const et=s.exports.memo(function(){return C(tt,{vertical:!0,children:[t(te,{}),C(nt,{vertical:!0,children:[t(U,{}),t(_,{}),t(ne,{})]})]})});et.displayName="SelectPage";const tt=i(f)`
	height: 100%;
	overflow-y: auto;
	&::-webkit-scrollbar {
		display: none;
...
//# sourceMappingURL=index.f10f4de0.js.map
